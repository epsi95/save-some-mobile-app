...
class FirstTimeInput extends StatefulWidget {
  final double monthlyUsageLimit;
  final String currencySymbol;

  FirstTimeInput({this.monthlyUsageLimit = 0.0, this.currencySymbol = '₹'});

  @override
  _FirstTimeInputState createState() => _FirstTimeInputState();
}

class _FirstTimeInputState extends State<FirstTimeInput> {
            ...
            RaisedButton(
                ...
                onPressed: buttonStatus
                    ? () async {
                        ...
                        DataBase.setFirstTimeUsingStatus();
